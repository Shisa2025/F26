...
export default function Home() {
  ...
  useEffect(() => {
    ...
    bindHover(
      document.querySelectorAll('.card-pop'),
      (el) => {
    ...
    bindHover(
      document.querySelectorAll('.threat-band'),
      (el) => {
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-10 flex flex-col gap-8">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/10 backdrop-blur-sm shadow-2xl p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4 frame-accent fade-hero">
          <div className="space-y-1">
            ...
            <div className="text-lg font-semibold text-white">Monitor, deploy, and brief teams in one surface.</div>
            <div className="text-sm text-white/70">Crisis / defense sim for demo. Live feel, simulated data.</div>
          </div>
        ...
        <div
          ref={cardsRef}
          className="rounded-2xl border border-white/10 bg-white/10 backdrop-blur-sm shadow-2xl p-4 grid grid-cols-1 md:grid-cols-3 gap-3 frame-accent"
        >
          {[
